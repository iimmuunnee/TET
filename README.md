...
1. **이름 입력** → 2. **성별 선택** → 3. **26문항 테스트** → 4. **결과 분석** → 5. **공유**
...
### Google AdSense
- 클라이언트 ID: `ca-pub-8774598116918128`
...
VITE_GA_MEASUREMENT_ID=G-3Y0Q8RM579
```
...
- ✨ **질문 26개로 확대** - 더 정교한 성격 분석
- 🎯 **실제 테토-에겐 특징 반영** - 과학적 근거 기반 질문
- 💡 **젊은 세대 특화** - SNS, 클럽, 연애 등 현실적 상황
