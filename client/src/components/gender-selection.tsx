      ...
      <div className="flex-1 flex items-center justify-center p-4 pt-16 sm:pt-20 md:pt-24">
        ...
        <div className="grid grid-cols-1 gap-3 sm:gap-4 mb-6 md:mb-8 px-2">
          <Button
            ...
            variant="outline"
            className={`group border-2 rounded-2xl p-4 sm:p-6 md:p-8 h-auto transition-all duration-300 md:transform md:hover:scale-105 focus:outline-none focus:ring-0 ${
              selectedGender === 'male' 
