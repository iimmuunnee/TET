...
export default function Result() {
  ...
  return (
    <div className="py-4 sm:py-6 md:py-8 px-4 bg-sky-100 dark:bg-slate-900 h-full overflow-y-auto"></div>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="result-capture bg-sky-100 dark:bg-slate-900 p-6 rounded-lg mb-8"></div>
          {/* Result Header */}
