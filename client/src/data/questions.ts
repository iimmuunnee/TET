...
const baseQuestions = [
  {
    ...
    mixedOption: { text: "분위기를 파악하며 자연스럽게 어울린다", type: "egen" as const, weight: 1.5 }, // 조화를 중시하므로 egen 쪽
  ...
  },
  {
    ...
    mixedOption: { text: "천천히 관찰하며 단계적으로 적응한다", type: "egen" as const, weight: 1.5 }, // 관찰 중심이므로 egen 쪽
  ...
  },
  {
    ...
    mixedOption: { text: "체계적으로 분석하되 신중하게 결정한다", type: "teto" as const, weight: 1.5 }, // 분석적 사고가 포함되므로 teto 쪽
  ...
  },
  {
    ...
    mixedOption: { text: "실용적인 해결책을 차근차근 모색한다", type: "teto" as const, weight: 1.5 }, // 해결책 찾기가 우선이므로 teto 쪽
  ...
  },
  {
    ...
    mixedOption: { text: "때로는 활동적이고 때로는 조용한 취미를 즐긴다", type: "egen" as const, weight: 1.5 }, // 다양성을 즐기지만 조용한 것도 포함하므로 egen 쪽
  ...
  },
  {
    ...
    mixedOption: { text: "신중하게 상황을 살피며 조화로운 해결책을 찾는다", type: "egen" as const, weight: 1.5 }, // 신중한 접근이므로 egen 쪽
  ...
  },
  {
    ...
    mixedOption: { text: "분위기를 보고 적절히 대응한다", type: "egen" as const, weight: 1.5 }, // 분위기 파악 우선이므로 egen 쪽
  ...
  },
  {
    ...
    mixedOption: { text: "솔직하되 상대방을 배려하며 표현한다", type: "teto" as const, weight: 1.5 }, // 상황 판단하여 행동하므로 teto 쪽
  ...
  },
  {
    ...
    mixedOption: { text: "기본 계획을 세우되 유연하게 조정한다", type: "teto" as const, weight: 1.5 }, // 계획을 세우는 것이 우선이므로 teto 쪽
  ...
  },
  {
    ...
    mixedOption: { text: "표정과 말투의 뉘앙스를 세심하게 관찰한다", type: "egen" as const, weight: 1.5 }, // 눈치로 파악하는 것이 포함되므로 egen 쪽
  ...
  },
  {
    ...
    mixedOption: { text: "감성을 자극하는 문화생활이나 취미활동", type: "egen" as const, weight: 1.5 }, // 기분에 따라 결정하므로 egen 쪽
    egenOption: { text: "독서나 영화 감상", type: "egen" as const, weight: 2 }
  },
  {
    text: "리더십이 필요한 상황에서...",
    tetoOption: { text: "자연스럽게 앞장서서 이끈다", type: "teto" as const, weight: 3 },
    mixedOption: { text: "필요에 따라 리더나 서포터 역할을 한다", type: "teto" as const, weight: 1.5 }, // 필요시 리더 역할을 하므로 teto 쪽
  ...
  },
  {
    ...
    mixedOption: { text: "상황에 맞게 표현 방식을 조절한다", type: "egen" as const, weight: 1.5 }, // 섬세한 조절이므로 egen 쪽
  ...
  },
  {
    ...
    mixedOption: { text: "경쟁과 즐거움의 균형을 맞춘다", type: "egen" as const, weight: 1.5 }, // 균형과 즐거움 중시하므로 egen 쪽
  ...
  },
  {
    ...
    mixedOption: { text: "때에 따라 실용성과 스타일을 고려한다", type: "egen" as const, weight: 1.5 }, // 스타일도 고려하므로 egen 쪽
  ...
  },
  {
    ...
    mixedOption: { text: "다양한 친구와 깊은 친구를 적절히 유지한다", type: "egen" as const, weight: 1.5 }, // 깊은 관계도 중시하므로 egen 쪽
    egenOption: { text: "깊고 진실한 소수의 관계를 중시한다", type: "egen" as const, weight: 2 }
  },
  {
    text: "업무나 과제를 처리할 때...",
    tetoOption: { text: "효율성과 결과를 중시한다", type: "teto" as const, weight: 2 },
    mixedOption: { text: "효율성과 완성도를 모두 고려한다", type: "egen" as const, weight: 1.5 }, // 완성도도 고려하므로 egen 쪽
    egenOption: { text: "완성도와 과정을 중시한다", type: "egen" as const, weight: 2 }
  },
  {
    text: "새로운 도전 앞에서 나는...",
    tetoOption: { text: "흥미롭고 자극적이라고 느낀다", type: "teto" as const, weight: 3 },
    mixedOption: { text: "설레지만 충분히 준비하고 싶어한다", type: "egen" as const, weight: 1.5 }, // 신중함이 포함되므로 egen 쪽
  ...
  },
  {
    ...
    mixedOption: { text: "상황과 기분에 따라 다양한 데이트", type: "egen" as const, weight: 1.5 }, // 기분에 따라 결정하므로 egen 쪽
  ...
  },
  {
    ...
    mixedOption: { text: "기본 계획을 세우되 유연하게 대응한다", type: "teto" as const, weight: 1.5 }, // 기본 계획을 세우므로 teto 쪽
